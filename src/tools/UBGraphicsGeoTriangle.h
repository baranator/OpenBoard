...
#ifndef UBGRAPHICSGEOTRIANGLE_H_
#define UBGRAPHICSGEOTRIANGLE_H_
...
class UBGraphicsGeoTriangle : public UBAbstractDrawRuler, public QGraphicsRectItem, public UBItem
{
    Q_OBJECT;

    public:
        UBGraphicsGeoTriangle();
        virtual ~UBGraphicsGeoTriangle();

        enum { Type = UBGraphicsItemType::GeoTriangleItemType };
    ...
    protected:
        ...
        void paintAngleGraduations(QPainter *painter);
...
#endif /* UBGRAPHICSGEOTRIANGLE_H_ */
